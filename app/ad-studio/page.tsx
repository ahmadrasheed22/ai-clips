...
export default function ProductAdStudioPage() {
  ...
  return (
    <main className="h-screen bg-neutral-950 text-neutral-100 p-3 md:p-5 flex flex-col items-center font-sans relative overflow-hidden">
      ...
      <div className="max-w-[1600px] w-full h-[calc(100vh-40px)] md:h-[calc(100vh-50px)] overflow-hidden flex flex-col space-y-3 relative z-10 mx-auto px-2 md:px-4">
        ...
        <div className="flex items-center justify-between border-b border-neutral-800/80 pb-2 pt-1 flex-shrink-0">
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-xs text-neutral-400 hover:text-white transition-colors bg-neutral-900/80 hover:bg-neutral-800 border border-neutral-800 rounded-lg px-3 py-1.5"
          >
          ...
          <span className="text-xs font-semibold px-2.5 py-0.5 rounded-full bg-purple-950/60 text-purple-400 border border-purple-800/50 flex items-center gap-1.5">
        ...
        <header className="text-left space-y-1 flex-shrink-0">
          <div className="inline-flex items-center gap-2 px-2.5 py-0.5 rounded-full bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/20 text-purple-300 text-xs font-medium">
          ...
          <p className="text-neutral-400 text-xs md:text-sm max-w-3xl">
        ...
        {errorMessage && (
          <div className="bg-red-950/40 border border-red-800/60 rounded-xl p-3 text-xs flex items-center justify-between text-red-300 flex-shrink-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6 items-stretch flex-1 min-h-0 overflow-hidden">
          {/* Left Column (5 Cols): Form Parameters with Strict Height & Internal Scroll */}
          <div className="lg:col-span-5 h-full overflow-y-auto pr-2 custom-scrollbar">
            <form
              onSubmit={handleFormSubmit}
              className="bg-neutral-900/60 backdrop-blur-xl border border-neutral-800/80 rounded-3xl p-4 space-y-4 shadow-2xl"
            >
...
function AdPreviewPlaceholder() {
  return (
    <div className="bg-neutral-900/40 backdrop-blur-xl border border-neutral-800/70 rounded-3xl p-4 md:p-6 shadow-2xl flex flex-col items-center justify-center text-center space-y-4 h-full max-h-full w-full relative overflow-hidden">
      <div className="w-14 h-14 rounded-2xl bg-purple-950/40 border border-purple-800/40 flex items-center justify-center text-purple-400 shadow-xl shadow-purple-950/50">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 w-full max-w-lg pt-1">
        <div className="bg-neutral-950/60 border border-neutral-800/80 rounded-xl p-3 text-center space-y-0.5">
